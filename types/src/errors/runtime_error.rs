...
impl Decodable for ErrorID {
    fn decode(rlp: &Rlp) -> Result<Self, DecoderError> {
        ...
        match tag {
            ...
            4 => Ok(ErrorID::InvalidStorageID),
            5 => Ok(ErrorID::InvalidTransferDestination),
            6 => Ok(ErrorID::NewOwnersMustContainSender),
            7 => Ok(ErrorID::InvalidSeq),
            8 => Ok(ErrorID::NonActiveAccount),
            9 => Ok(ErrorID::FailedToHandleCustomAction),
            10 => Ok(ErrorID::SignatureOfInvalid),
            11 => Ok(ErrorID::InsufficientStakes),
            12 => Ok(ErrorID::InvalidValidatorIndex),
