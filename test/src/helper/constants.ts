...
export const faucetAddress = SDK.Core.classes.Address.fromAccountId(
    faucetAccountId,
    { networkId: "tc" }
...
export const aliceAddress = SDK.Core.classes.Address.fromAccountId(
    aliceAccountId,
    { networkId: "tc" }
...
export const bobAddress = SDK.Core.classes.Address.fromAccountId(bobAccountId, {
    networkId: "tc"
...
export const carolAddress = SDK.Core.classes.Address.fromAccountId(
    carolAccountId,
    { networkId: "tc" }
...
export const daveAddress = SDK.Core.classes.Address.fromAccountId(
    daveAccountId,
    { networkId: "tc" }
...
export const validator0Address = SDK.Core.classes.Address.fromAccountId(
    validator0AccountId,
    { networkId: "tc" }
...
export const validator1Address = SDK.Core.classes.Address.fromAccountId(
    validator1AccountId,
    { networkId: "tc" }
...
export const validator2Address = SDK.Core.classes.Address.fromAccountId(
    validator2AccountId,
    { networkId: "tc" }
...
export const validator3Address = SDK.Core.classes.Address.fromAccountId(
    validator3AccountId,
    { networkId: "tc" }
