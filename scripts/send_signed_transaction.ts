import { Transaction, H256, U256, H160 } from "../src/primitives";
import { privateKeyToAddress } from "../src/Utils";
import { SDK } from "../src";
import { NoopAction, PaymentAction, AssetMintAction } from "../src/primitives/action/";
...
const noopAction = new NoopAction();
const paymentAction = new PaymentAction({
    address: new H160("3f4aa1fedf1f54eeb03b759deadb36676b184911"),
    value: new U256("10")
});
const assetMintAction = new AssetMintAction({
    metadata: "",
