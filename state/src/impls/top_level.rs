...
use crate::Asset;
use crate::{
    Account, ActionData, FindActionHandler, Metadata, MetadataAddress, Shard,
        ...
        let (transaction, approvers) = match action {
            ...
            | Action::ChangeAssetScheme {
                ...
                let approvers = approvals_to_approvers(
                    approvals,
                    |public| Ok(public_to_address(public)),
                    &transaction_tracker,
                )?;
...
mod tests_tx {
    ...
    fn cannot_mint_twice_in_different_transaction() {
        ...
        assert_eq!(
            Err(RuntimeError::AssetSchemeDuplicated {
    ...
    fn wrap_and_failed_unwrap() {
        ...
        assert_eq!(
            Err(RuntimeError::ScriptHashMismatch(Mismatch {
    ...
    fn transfer_failed_if_the_input_amount_is_not_valid() {
        ...
        assert_eq!(
            Err(RuntimeError::InvalidAssetQuantity {
                shard_id,
    ...
    fn multi_shard_transfer_failed_if_the_shard_id_of_input_is_not_valid() {
        ...
        assert_eq!(
            Err(RuntimeError::AssetSchemeNotFound {
