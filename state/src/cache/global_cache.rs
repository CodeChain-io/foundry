...
use crate::{Account, ActionData, AssetScheme, Metadata, OwnedAsset, Shard, ShardText};
use ctypes::ShardId;
...
impl Default for GlobalCache {
    fn default() -> Self {
        ...
        Self::new(N_ACCOUNT, N_SHARD, N_ACTION_DATA, N_ASSET_SCHEME, N_ASSET, N_SHARD_TEXT)
    }
}
