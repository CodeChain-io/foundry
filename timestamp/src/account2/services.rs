...
pub trait AccountManager: Service {
    ...
    // Mutable accesses
    fn create_account(&self, session: SessionKey, public: &Public) -> Result<(), Error>;
    fn increase_sequence(&self, session: SessionKey, public: &Public, default: bool) -> Result<(), Error>;
}
...
impl TxOwner for ServiceHandler {
    fn block_opened(&self, _: SessionKey, _: &Header) -> Result<(), HeaderError> {
        Ok(())
    }
